...
<div class="container mt-5">
    ...
    <form action="<?= base_url('bioskop/update/' . $bioskop->id_bioskop) ?>" method="post">
        ...
        <div class="form-group">
            ...
            <input type="time" class="form-control" id="jam_buka" name="jam_buka" value="<?= esc($bioskop->jam_buka) ?>" step="60">
        </div>

        <div class="form-group">
            <label for="jam_tutup">Jam Tutup (24 Jam)</label>
            <input type="time" class="form-control" id="jam_tutup" name="jam_tutup" value="<?= esc($bioskop->jam_tutup) ?>" step="60">
        </div>
